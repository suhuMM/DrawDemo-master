...
public class SignatureView extends View {
	...
	public SignatureView(Context context, AttributeSet attrs) {
		...
		try {
			...
			mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, convertDpToPx(3));
...
//				mLastTouchX = eventX;
//				mLastTouchY = eventY;
//				addPoint(new TimedPoint(eventX, eventY));//添加点的值
//				Log.i("zhong","X="+eventX+"Y="+eventY);
//
...
//
	...
	public void up(float eventX,float eventY){
		resetDirtyRect(eventX, eventY);
		addPoint(new TimedPoint(eventX, eventY));//添加点的值
		Log.i("zhong","X="+eventX+"Y="+eventY);
		getParent().requestDisallowInterceptTouchEvent(true);
